...
const Contact = () => {
    return(
        <div className="flex flex-col justify-center items-center min-h-screen py-12 bg-cover bg-center" 
        style={{backgroundImage:"url('https://cdn.pixabay.com/photo/2016/02/17/15/37/laptop-1205256_1280.jpg')"}}>
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
                <h1 className="text-center font-bold text-4xl mb-6">
                    Contact Us
                </h1>
                <p className="text-gray-600 text-centre mb-4">
