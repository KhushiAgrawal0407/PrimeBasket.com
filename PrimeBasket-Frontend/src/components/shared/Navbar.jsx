...
import { FaShoppingBasket, FaShoppingCart, FaSignInAlt } from "react-icons/fa";
        ...
        <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                <Link to="/" className="flex items-center text-2xl font-bold">
                    <FaShoppingBasket className="mr-2 text-3xl"/>
                ...
                ${
                    ...
                    {(user && user.id) ? (
                        ...
                        <li className="font-[500] transition-all duration-150">
                            <Link className="flex items-center space-x-2 px-4 py-[6px] bg-gradient-to-r from-purple-600 to-red-500 text-white font-semibold rounded-md
